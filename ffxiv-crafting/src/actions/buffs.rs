...
use crate::{
    actions::CanExecute,
    buffs::{quality::InnerQuietBaseStacks, Buff, BuffState, DurationalBuff},
...
/// Activates the [`InnerQuiet`] for 18CP, giving a 20% bonus to quality generated by the control stat
/// per [`touch`] (quality increasing) action used, and also enabling [`ByregotsBlessing`].
///
/// [`InnerQuiet`]: crate::buffs::quality::InnerQuiet
...
#[ffxiv_durability(cost = 0)]
#[ffxiv_buff_act(activate = "durability.manipulation")]
